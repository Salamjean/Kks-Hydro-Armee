        ...
        <ul class="menu">
           ...
           <li class="sidebar-item has-sub {{ request()->routeIs('corps.personnel.*') ? 'active' : '' }}">
            ...
            <li class="sidebar-item has-sub {{ request()->routeIs('corps.personnel.*') ? 'active' : '' }}">
                ...
                <ul class="submenu">
                    <li class="submenu-item {{ request()->routeIs('corps.gendarmerie.profile') || request()->routeIs('corps.gendarmerie.profile') ? 'active' : '' }}">
                        <a href="{{ route('corps.gendarmerie.profile') }}">Mon Profil</a>
                    </li>
                </ul>
            </li>
